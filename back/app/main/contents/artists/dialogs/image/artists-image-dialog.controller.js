(function ()
{
    ...
    angular
        ...
        .controller('ArtistmageDialogController', controller);

    /** @ngInject */
    function controller($mdDialog, Avatar, msUtils, $translate, msApi, ngProgressLite, $mdToast, $timeout, $cookies, $log, $scope, Cropper)
    {
        var vm = this;
